...
var images = [
  ...
  "img/Naruto.jpg",
  "img/Noragami.jpg",
  "img/Tokyo%20Ghoul.jpg",
];
var descriptions = ["Gintama", "Drifters", "Naruto", "Noragami", "Tokyo Ghoul"];
var interval;
var time = 2000;
var action = "";

var thumbs = ["Gintama", "Drifters", "Naruto", "Noragami", "Tokyo"];

function changeThumbs() {
  for (var i = 0; i < images.length; i++) {
    if (i !== current) document.getElementById(thumbs[i]).style.opacity = 0.5;
  }
